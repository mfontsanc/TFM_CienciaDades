...
api = Namespace(constants.FUNCTIONALITIES[constants.KEY_NETWORK_GET_COMMUNITIES_CT][constants.KEY_TITLE],
                description=constants.FUNCTIONALITIES[constants.
                KEY_NETWORK_GET_COMMUNITIES_CT][constants.KEY_DESCRIPTION])

""" Output data model definition """
insert_output_get_community = api.model('OutputGetCommunityCT', {
...
@api.route(constants.FUNCTIONALITIES[constants.KEY_NETWORK_GET_COMMUNITIES_CT][constants.KEY_TITLE_END_POINT])
class GetCommunities(Resource):
    @api.doc(constants.FUNCTIONALITIES[constants.KEY_NETWORK_GET_COMMUNITIES_CT][constants.KEY_DOC])
